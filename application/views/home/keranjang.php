				...
				<div class="row">
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								<li><a href="<?php echo base_url();?>home/tentang_kami"> About Us</a></li>
								<li><a href="<?php echo base_url();?>home/cara_belanja"> Cara Belanja</a></li>
								<li><a href="<?php echo base_url();?>home/hubungi_kami"> Kontak Kami</a></li>
								<li><a href="<?php echo base_url();?>home/keranjang"> Keranjang</a></li>
							</ul>
						</div>
					</div>
				</div>
	...
	<section id="cart_items">
		<div class="container">
			...
			<?php if(!$this->cart->contents()):
				echo 'Keranjang anda masih kosong, kembali ke Beranda untuk belanja.';
			else:
			?>
		...
		<tr>
			...
			<ul>
				<li>Klik tombol Update Belanja apabila ada perubahan Jumlah (Qty)</li>
				<li>Apabila ingin menghapus barang, klik tombol Hapus.</li>
...
?>
	...
	<footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2019 Ayyu|Sulis|Farras. All rights reserved.</p>
