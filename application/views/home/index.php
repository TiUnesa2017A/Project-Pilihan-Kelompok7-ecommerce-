						...
						<div class="carousel-inner">
							...
							foreach ($slider->result_array() as $value) {
								...
								<div class="item active">
									<div class="col-sm-6">
										<h1><span>TOKOku</span>.com</h1>
										<h2><?php echo $value['tittle'];?></h2>
										<p><?php echo strip_tags(substr($value['description'],0,250));?></p>
			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Produk Spesial</h2>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											...
											<h2>IDR <?php echo $value['harga'];?></h2>
